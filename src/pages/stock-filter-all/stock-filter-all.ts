...
/**
 * Generated class for the StockFilterAllPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-stock-filter-all',
  templateUrl: 'stock-filter-all.html',
})
export class StockFilterAllPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad StockFilterAllPage');
  }
  ...
  details(article: Article, i: number) {
    this.selected = i;
    this.navCtrl.push(StockDetailPage, {article: article, from: StockFilterAllPage });
  }
